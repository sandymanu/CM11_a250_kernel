...
void bq24158setDefaultV(void);//LINE<20130708><battery locked>wangyanhui
#endif
...
int hw_check_battery(void)
{
    ...
    else
    {
        ...
        #if defined(MTK_BQ24158_SUPPORT)
		bq24158setDefaultV();//LINE<20130708><battery locked>wangyanhui
        #endif
        //ret_val=pmic_config_interface(CHR_CON7,    0x00, PMIC_RG_BATON_EN_MASK, PMIC_RG_BATON_EN_SHIFT);      //BATON_EN=0
        //ret_val=pmic_config_interface(CHR_CON7,    0x00, PMIC_BATON_TDET_EN_MASK, PMIC_BATON_TDET_EN_SHIFT);  //BATON_TDET_EN=0
        //ret_val=pmic_config_interface(AUXADC_CON0, 0x00, PMIC_RG_BUF_PWD_B_MASK, PMIC_RG_BUF_PWD_B_SHIFT);    //RG_BUF_PWD_B=0
...
//BEGIN<20130708><battery locked>wangyanhui
#if defined(MTK_BQ24158_SUPPORT)
...
void bq24158setDefaultV(void)
{
	...
	write_data[0]=0x6;
	//write_data[1]=0x70;
	write_data[1]=0x78; //LINE<JIRA_ID><DATE20130712><S9311 high bat>zenghaihui
	mt_i2c_write(I2C_NUM, bq24158_SLAVE_ADDR_WRITE, write_data, 2,1);
...
#endif
//END<20130708><battery locked>wangyanhui
