...
MINT32 AcdkMhalEng::acdkMhal3ASetParam(MINT32 devID, MUINT8 IsFactory)
{
  ...
  cam3aParam.rNewParam.i4MaxFps = 300;
    ...
    //BEGIN<20130730><FTM sub-camera test with flashlight>wangyanhui
    if(IsFactory && devID == 2)
    {
	XLOGD("line=%d factory flash=LIB3A_FLASH_MODE_FORCE_OFF ",__LINE__);
	cam3aParam.u4StrobeMode =2; //LIB3A_FLASH_MODE_FORCE_OFF
    }
    //END<20130730><FTM sub-camera test with flashlight>wangyanhui
