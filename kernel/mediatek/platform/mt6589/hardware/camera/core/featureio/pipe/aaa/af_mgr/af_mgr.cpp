...
{
    // BEGIN <20130813><SJSIIB-46><can't focus after swith to main> Jiangde
    m_FDArea.i4Count=0; 
    m_pIAfAlgo->setFDWin(m_FDArea);
    // END <20130813><SJSIIB-46><can't focus after swith to main> Jiangde 
...
*/
    ...
    // 13 bits (8192x8192) - double buffer, "must even position"
        wintmp=(Boundary(WIN_POS_MIN, i4X,            m_i4AF_in_Hsize-WIN_POS_MIN)&0x1FFF)+ ((Boundary(WIN_POS_MIN, i4X + i4WOri  , m_i4AF_in_Hsize-WIN_POS_MIN)&0x1FFF)<<16);
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINX01,  wintmp );
        wintmp=(Boundary(WIN_POS_MIN, i4X + i4WOri*2, m_i4AF_in_Hsize-WIN_POS_MIN)&0x1FFF)+ ((Boundary(WIN_POS_MIN, i4X + i4WOri*3, m_i4AF_in_Hsize-WIN_POS_MIN)&0x1FFF)<<16);
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINX23, wintmp );
        wintmp=(Boundary(WIN_POS_MIN, i4X + i4WOri*4, m_i4AF_in_Hsize-WIN_POS_MIN)&0x1FFF)+ ((Boundary(WIN_POS_MIN, i4X + i4WOri*5, m_i4AF_in_Hsize-WIN_POS_MIN)&0x1FFF)<<16);
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINX45, wintmp );

        wintmp=(Boundary(WIN_POS_MIN, i4Y,            m_i4AF_in_Vsize-WIN_POS_MIN)&0x1FFF)+ ((Boundary(WIN_POS_MIN, i4Y + i4HOri*2 - i4H, m_i4AF_in_Vsize-WIN_POS_MIN)&0x1FFF)<<16);
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINY01,wintmp);
        wintmp=(Boundary(WIN_POS_MIN, i4Y + i4HOri*2, m_i4AF_in_Vsize-WIN_POS_MIN)&0x1FFF)+ ((Boundary(WIN_POS_MIN, i4Y + i4HOri*2 + i4H, m_i4AF_in_Vsize-WIN_POS_MIN)&0x1FFF)<<16);
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINY23,wintmp);
        wintmp=(Boundary(WIN_POS_MIN, i4Y + i4HOri*4, m_i4AF_in_Vsize-WIN_POS_MIN)&0x1FFF)+ ((Boundary(WIN_POS_MIN, i4Y + i4HOri*5, m_i4AF_in_Vsize-WIN_POS_MIN)&0x1FFF)<<16);
    ...
    if (m_FDArea.i4Count)   {
        ...
        // 13 bits (8192x8192) - double buffer, "must even position"
            ISP_WRITE_REG(m_pIspReg , CAM_AF_WIN_E, (i4XE & 0x1FFF) + ((i4YE&0x1FFF)<<16) );

        // 12 bits (4096x4096) - double buffer
            ISP_WRITE_REG(m_pIspReg , CAM_AF_SIZE_E, (Boundary(FL_WIN_SIZE_MIN, (m_FDArea.sRect[0].i4W>>1)<<1, m_i4AF_in_Hsize - i4XE - FL_WIN_POS_MIN) & 0xFFF) 
            + ((Boundary(FL_WIN_SIZE_MIN, (m_FDArea.sRect[0].i4H>>1)<<1, m_i4AF_in_Vsize - i4YE - FL_WIN_POS_MIN)&0xFFF)<<16) );
        }
    }
    else   {        
        // setAFFloatingWinConfig
        ...
        {   
        // 13 bits (8192x8192) - double buffer, "must even position"
            ISP_WRITE_REG(m_pIspReg , CAM_AF_WIN_E, (Boundary(FL_WIN_POS_MIN, i4X + i4WOri*2, m_i4AF_in_Hsize - FL_WIN_POS_MIN) & 0x1FFF) 
            + ((Boundary(FL_WIN_POS_MIN, i4Y + i4HOri*2, m_i4AF_in_Vsize - FL_WIN_POS_MIN)&0x1FFF)<<16) );
        // 12 bits (4096x4096) - double buffer
            ISP_WRITE_REG(m_pIspReg , CAM_AF_SIZE_E, (Boundary(FL_WIN_SIZE_MIN, i4W*2, FL_WIN_SIZE_MAX) & 0xFFF) 
            + ((Boundary(FL_WIN_SIZE_MIN, i4H*2, FL_WIN_SIZE_MAX)&0xFFF)<<16) );
        }
    }
...
MVOID AfMgr::setAFWinConfig(AF_AREA_T a_sAFArea)
{
    ...
    // 13 bits (8192x8192) - double buffer, "must even position"
        ...
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINX01,  (i4X    &     0x1FFF) + (((i4X + i4W  )&0x1FFF)<<16) );
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINX23, ((i4X + i4W*2)&0x1FFF) + (((i4X + i4W*3)&0x1FFF)<<16) );
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINX45, ((i4X + i4W*4)&0x1FFF) + (((i4X + i4W*5)&0x1FFF)<<16) );
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINY01,  (i4Y    &     0x1FFF) + (((i4Y + i4H  )&0x1FFF)<<16) );
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINY23, ((i4Y + i4H*2)&0x1FFF) + (((i4Y + i4H*3)&0x1FFF)<<16) );
        ISP_WRITE_REG(m_pIspReg , CAM_AF_WINY45, ((i4Y + i4H*4)&0x1FFF) + (((i4Y + i4H*5)&0x1FFF)<<16) );

        // 9 bits (1022x1022) - double buffer
        ISP_WRITE_REG(m_pIspReg , CAM_AF_SIZE, (i4W & 0x1FF) + ((i4H&0x1FF)<<16) );
    }
    ...
    {   // setAFFloatingWinConfig
        ...
        {   
    // 13 bits (8192x8192) - double buffer, "must even position"
            ISP_WRITE_REG(m_pIspReg , CAM_AF_WIN_E, (Boundary(FL_WIN_POS_MIN, i4X, m_i4AF_in_Hsize - FL_WIN_POS_MIN) & 0x1FFF) 
            + ((Boundary(FL_WIN_POS_MIN, i4Y, m_i4AF_in_Hsize - FL_WIN_POS_MIN)&0x1FFF)<<16) );
    // 12 bits (4096x4096) - double buffer
            ISP_WRITE_REG(m_pIspReg , CAM_AF_SIZE_E, (Boundary(FL_WIN_SIZE_MIN, i4W, FL_WIN_SIZE_MAX) & 0xFFF) 
            + ((Boundary(FL_WIN_SIZE_MIN, i4H, FL_WIN_SIZE_MAX)&0xFFF)<<16) );
         }
    }
}
