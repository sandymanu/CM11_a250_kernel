...
{
/* CHUER. DATE20131012. BEGIN */
//#ifdef EN_CUSTOM_EXIF_INFO
#if defined(CUSTOM_BLU_OPEN_VERSION)
#define CUSTOM_EXIF_STRING_MAKE  "BLU"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
#define CUSTOM_EXIF_STRING_MODEL "LIFE ONE X"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
#define CUSTOM_EXIF_STRING_SOFTWARE "LIFE ONE X"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
